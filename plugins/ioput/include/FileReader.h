...
public:
	...
	public:
		...
		Options ()
			: type (File::BINARY), block (0), blockInSamples (1), loop (true), offset (0), offsetInSamples (0), cutoff (0), cutoffInSamples (0) {
...
public:
	...
	static const ssi_char_t *GetCreateName () { return "ssi_sensor_FileReader"; };
...
protected:
	...
	bool read_file (const ssi_char_t *path);
	bool prepare_file ();
