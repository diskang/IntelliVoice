...
#define SSI_MOUSE_BUTTON_SAMPLE_TYPE		ssi_size_t
...
public:
	...
	public:
		...
		Options ()
			...
			addOption ("single", &single, 1, SSI_BOOL, "fire single event when button is pressed");

			addOption("event", &sendEvent, 1, SSI_BOOL, "send an event if button is pressed");
