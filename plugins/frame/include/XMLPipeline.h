...
public:
	...
	static const ssi_char_t *GetCreateName () { return "ssi_object_XMLPipeline"; }
	...
	bool parse (const ssi_char_t *filepath, ssi_size_t n_confs = 0, ssi_char_t **confpaths = 0, bool savepipe = false);
	...
	virtual bool startPainter () {
		return _start_painter;
	}
