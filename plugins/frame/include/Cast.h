...
public:
	...
	public:
		...
		Options () : cast (SSI_FLOAT) {			
			...
			addOption ("cast", &cast, 1, SSI_SIZE, "cast type (CHAR = 1, UCHAR = 2, SHORT = 3, USHORT = 4, INT = 5, UINT = 6, LONG = 7, ULONG = 8, FLOAT = 9, DOUBLE = 10, LDOUBLE = 11, STRUCT = 12, IMAGE = 13, BOOL = 14");
		};
...
public:
	...
	static const ssi_char_t *GetCreateName () { return "ssi_filter_Cast"; };
