...
#ifndef SSI_SIGNAL_AUDIOACTIVITY_H
#define SSI_SIGNAL_AUDIOACTIVITY_H
		...
		public:
			...
			Options ()
				: threshold (0.0f), method (LOUDNESS) {
					...
					addOption ("threshold", &threshold, 1, SSI_REAL, "Threshold to determine activity");
			};		
...
public:
	...
	static const ssi_char_t *GetCreateName () { return "ssi_feature_AudioActivity"; };
