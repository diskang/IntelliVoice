...
public:
	...
	void paint(ICanvas *canvas, ssi_handle_t device, ssi_rect_t rect);
	void clear();
	void mouseDown(ICanvas *canvas, ssi_point_t position, IWindowClient::KEY vkey);
	void keyDown(ICanvas *canvas, IWindowClient::KEY key, IWindowClient::KEY vkey);
