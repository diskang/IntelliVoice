...
public:
	...
	static const ssi_char_t *GetCreateName () { return "ssi_filter_Operator0"; };
	static IObject *Create (const ssi_char_t *file) { return new Operator0 (); };
	~Operator0 ();
	...
	virtual void set (ssi_opfun0_t function);
