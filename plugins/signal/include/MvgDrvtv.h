...
public:
	...
	static const ssi_char_t *GetCreateName () { return "ssi_filter_MvgDrvtv"; };
	static IObject *Create (const ssi_char_t *file) { return new MvgDrvtv (file); };
	~MvgDrvtv ();

	Options *getOptions () { return &_options; };
	const ssi_char_t *getName () { return GetCreateName (); };
	const ssi_char_t *getInfo () { return "Computes moving/sliding derivative of the input stream for the chosen window."; };
