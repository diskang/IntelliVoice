...
Calculates moving/sliding convergence/divergence of signal.
...
public:
	...
	static const ssi_char_t *GetCreateName () { return "ssi_filter_MvgConDiv"; };
	static IObject *Create (const ssi_char_t *file) { return new MvgConDiv (file); };
	~MvgConDiv ();

	Options *getOptions () { return &_options; };
	const ssi_char_t *getName () { return GetCreateName (); };
	const ssi_char_t *getInfo () { return "Computs moving/sliding convergence/divergence for the chosen window."; };
