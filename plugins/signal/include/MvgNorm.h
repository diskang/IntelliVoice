...
Normalizes signal in given range.
...
public:
	...
	static const ssi_char_t *GetCreateName () { return "ssi_filter_MvgNorm"; };
	static IObject *Create (const ssi_char_t *file) { return new MvgNorm (file); };
	~MvgNorm ();

	Options *getOptions () { return &_options; };
	const ssi_char_t *getName () { return GetCreateName (); };
	const ssi_char_t *getInfo () { return "Normalizes input stream using moving/sliding minim and/or maximum for the chosen window."; };
