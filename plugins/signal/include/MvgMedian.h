...
public:
	...
	static const ssi_char_t *GetCreateName () { return "ssi_filter_MvgMedian"; };
	static IObject *Create (const ssi_char_t *file) { return new MvgMedian (file); };
	~MvgMedian ();

	Options *getOptions () { return &_options; };
	const ssi_char_t *getName () { return GetCreateName (); };
	const ssi_char_t *getInfo () { return "Computes median of the input stream for the chosen window"; };
