...
Provides moving or sliding average and/or variance.
...
public:
	...
	public:
		...
		Options () 
			...
			addOption ("set_above", &set_above, 1, SSI_REAL, "if 'replace_below=SET' this value will be used");
...
public:
	...
	static const ssi_char_t *GetCreateName () { return "ssi_filter_Bundle"; };
	static IObject *Create (const ssi_char_t *file) { return new Bundle (file); };
	~Bundle ();

	Options *getOptions () { return &_options; };
	const ssi_char_t *getName () { return GetCreateName (); };
	const ssi_char_t *getInfo () { return "Computes moving/sliding average and/or variance of the input stream for the chosen window"; };
