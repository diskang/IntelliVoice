...
public:
	...
	static const ssi_char_t *GetCreateName () { return "ssi_feature_Spectrogram"; };
	...
	virtual void readFilterbank (const ssi_char_t *file, ssi_time_t sr);
