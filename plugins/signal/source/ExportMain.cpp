...
DLLEXP bool Register (ssi::Factory *factory, FILE *logfile, ssi::IMessage *message) {
	...
	result = ssi::Factory::Register (ssi::Operator0::GetCreateName (),ssi::Operator0::Create) && result;
	result = ssi::Factory::Register (ssi::Operator1::GetCreateName (),ssi::Operator1::Create) && result;
