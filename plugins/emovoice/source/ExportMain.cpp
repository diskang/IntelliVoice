...
DLLEXP bool Register (ssi::Factory *factory, FILE *logfile, ssi::IMessage *message) {
	...
	result = ssi::Factory::Register (ssi::EmoVoiceBayes::GetCreateName (), ssi::EmoVoiceBayes::Create) && result;		
	result = ssi::Factory::Register (ssi::EmoVoiceSVM::GetCreateName (), ssi::EmoVoiceSVM::Create) && result;	
