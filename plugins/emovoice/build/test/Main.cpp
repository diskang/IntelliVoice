...
int main (int argc, const char* argv[]) {
	...
	Factory::RegisterDLL ("../../../../bin/x64/vc140/ssiframe.dll");	
	Factory::RegisterDLL ("../../../../bin/x64/vc140/ssievent.dll");	
	Factory::RegisterDLL ("../../../../bin/x64/vc140/ssiemovoice.dll");
	Factory::RegisterDLL ("../../../../bin/x64/vc140/ssigraphic.dll");
	Factory::RegisterDLL ("../../../../bin/x64/vc140/ssimodel.dll");
	Factory::RegisterDLL ("../../../../bin/x64/vc140/ssiaudio.dll");
	Factory::RegisterDLL ("../../../../bin/x64/vc140/ssisignal.dll");
	Factory::RegisterDLL ("../../../../bin/x64/vc140/ssiioput.dll");	
...
void PlotSamples (ISamples &samples, const ssi_char_t *name) {
	...
	for (ssi_size_t n_class = 0; n_class < n_classes; n_class++) {
		...
		plots[n_class]->setLimits (min[0], max[0]);
		//plots[n_class]->setData(samples->getStream(n_class),PaintData::TYPE::SCATTER); //(data, n_samples * n_streams);		
