...
bool Buffer::get (ssi_byte_t *data, ssi_size_t position, ssi_size_t bytes) {
...
bool Buffer::put (const ssi_byte_t *data, ssi_size_t position, ssi_size_t bytes) {
...
bool Buffer::putZeros (ssi_size_t position, ssi_size_t bytes) {
