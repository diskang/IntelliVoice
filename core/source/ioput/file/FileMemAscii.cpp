...
bool FileMemAscii::read (void *ptr, ssi_size_t size, ssi_size_t count) {
	...
	switch (_type) {
		...
		case SSI_UCHAR:
			...
			break;
		case SSI_SHORT:
			result = FileMemAscii::read_h<short> (_pos, _n_memory, _memory, _format_with_delim_read, _format_with_newline_read, ptr, size, count);
			break;
		case SSI_USHORT:
			result = FileMemAscii::read_h<unsigned short> (_pos, _n_memory, _memory, _format_with_delim_read, _format_with_newline_read, ptr, size, count);
			break;
		case SSI_INT:
			result = FileMemAscii::read_h<int> (_pos, _n_memory, _memory, _format_with_delim_read, _format_with_newline_read, ptr, size, count);
			break;
		case SSI_UINT:
			result = FileMemAscii::read_h<unsigned int> (_pos, _n_memory, _memory, _format_with_delim_read, _format_with_newline_read, ptr, size, count);
			break;
		case SSI_LONG:
			result = FileMemAscii::read_h<long> (_pos, _n_memory, _memory, _format_with_delim_read, _format_with_newline_read, ptr, size, count);
			break;
		case SSI_ULONG:
			result = FileMemAscii::read_h<unsigned long> (_pos, _n_memory, _memory, _format_with_delim_read, _format_with_newline_read, ptr, size, count);
			break;
		case SSI_FLOAT:
...
bool FileMemAscii::write (const void *ptr, ssi_size_t size, ssi_size_t count) {
	...
	switch (_type) {
		...
		case SSI_UCHAR:
			...
			break;
		case SSI_SHORT:
			result = FileMemAscii::write_h<short> (_pos, _n_memory, _memory, _format_with_delim, _format_with_newline, ptr, size, count);
			break;
		case SSI_USHORT:
			result = FileMemAscii::write_h<unsigned short> (_pos, _n_memory, _memory, _format_with_delim, _format_with_newline, ptr, size, count);
			break;
		case SSI_INT:
			result = FileMemAscii::write_h<int> (_pos, _n_memory, _memory, _format_with_delim, _format_with_newline, ptr, size, count);
			break;
		case SSI_UINT:
			result = FileMemAscii::write_h<unsigned int> (_pos, _n_memory, _memory, _format_with_delim, _format_with_newline, ptr, size, count);
			break;
		case SSI_LONG:
			result = FileMemAscii::write_h<long> (_pos, _n_memory, _memory, _format_with_delim, _format_with_newline, ptr, size, count);
			break;
		case SSI_ULONG:
			result = FileMemAscii::write_h<unsigned long> (_pos, _n_memory, _memory, _format_with_delim, _format_with_newline, ptr, size, count);
			break;
		case SSI_FLOAT:
...
bool FileMemAscii::writeLine (const ssi_char_t *string) {
...
bool FileMemAscii::readLine (ssi_size_t num, ssi_char_t *string) {
