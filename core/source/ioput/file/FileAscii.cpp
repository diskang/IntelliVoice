...
bool FileAscii::read (void *ptr, ssi_size_t size, ssi_size_t count) {
	...
	switch (_type) {
		...
		case SSI_UCHAR:
			...
			break;
		case SSI_SHORT:
			result = FileAscii::read_h<short> (_file, _format_with_delim, _format_with_newline, ptr, size, count);
			break;
		case SSI_USHORT:
			result = FileAscii::read_h<unsigned short> (_file, _format_with_delim, _format_with_newline, ptr, size, count);
			break;
		case SSI_INT:
			result = FileAscii::read_h<int> (_file, _format_with_delim, _format_with_newline, ptr, size, count);
			break;
		case SSI_UINT:
			result = FileAscii::read_h<unsigned int> (_file, _format_with_delim, _format_with_newline, ptr, size, count);
			break;
		case SSI_LONG:
			result = FileAscii::read_h<long> (_file, _format_with_delim, _format_with_newline, ptr, size, count);
			break;
		case SSI_ULONG:
			result = FileAscii::read_h<unsigned long> (_file, _format_with_delim, _format_with_newline, ptr, size, count);
			break;
		case SSI_FLOAT:
...
template<class T>
SSI_INLINE bool FileAscii::read_h (FILE *file, const ssi_char_t *format_with_delim, const ssi_char_t *format_with_newline, void *ptr, ssi_size_t size, ssi_size_t count) {
...
bool FileAscii::write (const void *ptr, ssi_size_t size, ssi_size_t count) {
	...
	switch (_type) {
		...
		case SSI_UCHAR:
			...
			break;
		case SSI_SHORT:
			result = FileAscii::write_h<short> (_file, _format_with_delim, _format_with_newline, ptr, size, count);
			break;
		case SSI_USHORT:
			result = FileAscii::write_h<unsigned short> (_file, _format_with_delim, _format_with_newline, ptr, size, count);
			break;
		case SSI_INT:
			result = FileAscii::write_h<int> (_file, _format_with_delim, _format_with_newline, ptr, size, count);
			break;
		case SSI_UINT:
			result = FileAscii::write_h<unsigned int> (_file, _format_with_delim, _format_with_newline, ptr, size, count);
			break;
		case SSI_LONG:
			result = FileAscii::write_h<long> (_file, _format_with_delim, _format_with_newline, ptr, size, count);
			break;
		case SSI_ULONG:
			result = FileAscii::write_h<unsigned long> (_file, _format_with_delim, _format_with_newline, ptr, size, count);
			break;
		case SSI_FLOAT:
...
template<class T>
SSI_INLINE bool FileAscii::write_h (FILE *file, const ssi_char_t *format_with_delim, const ssi_char_t *format_with_newline, const void *ptr, ssi_size_t size, ssi_size_t count) {
...
bool FileAscii::writeLine (const ssi_char_t *string) {
...
bool FileAscii::readLine (ssi_size_t num, ssi_char_t *string) {
