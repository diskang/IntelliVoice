...
public:
	...
	bool read (void *ptr, ssi_size_t elements_per_line, ssi_size_t count);
	...
	bool write (const void *ptr, ssi_size_t elements_per_line, ssi_size_t count);
...
protected:
	...
	template<class T>
	static bool read_h (FILE *file, const ssi_char_t *format_with_delim, const ssi_char_t *format_with_newline, void *ptr, ssi_size_t elements_per_line, ssi_size_t count);
	template<class T>
	static bool write_h (FILE *file, const ssi_char_t *format_with_delim, const ssi_char_t *format_with_newline, const void *ptr, ssi_size_t elements_per_line, ssi_size_t count);
