...
public: 	
	...
	virtual ITransformable *AddProvider (ISensor *isensor,
		...
		IFilter *ifilter = 0,
		ssi_time_t buffer_capacity_in_seconds = 10.0,
		ssi_time_t check_interval_in_seconds = 1.0,
		ssi_time_t sync_interval_in_seconds = 5.0) = 0;
	...
	virtual ITransformable *AddTransformer (ITransformable *source, 
		...
		ssi_time_t buffer_capacity = 10.0) = 0;
	virtual ITransformable *AddTransformer (ITransformable *source, 
	...
	virtual int GetData (int buffer_id, ssi_byte_t *data, ssi_size_t samples, ssi_size_t position) = 0;
	...
	virtual bool GetCurrentWritePos (int buffer_id, ssi_size_t &position) = 0;
