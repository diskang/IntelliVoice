...
public:
	...
	virtual bool RegisterSender (IEventSender &sender) = 0; // register sender sending one or more events to the board
	virtual bool RegisterListener (IEventListener &listener,		
