...
public:
	...
	virtual ~Buffer ();
	bool get (ssi_byte_t *data, ssi_size_t position, ssi_size_t bytes);
	bool put (const ssi_byte_t *data, ssi_size_t position, ssi_size_t bytes);
	bool putZeros (ssi_size_t position, ssi_size_t bytes);
