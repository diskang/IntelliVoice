...
public:
	...
	TimeBuffer (ssi_time_t capacity, ssi_time_t sample_rate, ssi_size_t sample_dimension, ssi_size_t sample_bytes, ssi_type_t sample_type);
	virtual ~TimeBuffer ();
	...
	TimeBuffer::STATUS get (ssi_byte_t *data, ssi_size_t samples, ssi_size_t position);
...
private:
	...
	ssi_size_t next_sample; // write position
	ssi_size_t last_accessed_sample; // last accessed sample index
