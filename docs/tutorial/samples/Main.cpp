...
bool ex_filter(void *args) {
	...
	frame->Start ();
	painter->ArrangeRelative (4, 1, 0, 0, 0.75f, 0.95f);
	painter->MoveConsoleRelative (0.75f, 0, 0.25f, 0.95f);
	frame->Wait ();
	frame->Stop ();
	frame->Clear ();
	painter->Clear ();
...
bool ex_feature(void *args) {
	...
	frame->Start ();
	painter->ArrangeRelative (1, 3, 0, 0, 0.75f, 0.95f);
	painter->MoveConsoleRelative (0.75f, 0, 0.25f, 0.95f);
	frame->Wait ();
	frame->Stop ();
	frame->Clear ();
