...
public:
	...
	static bool SamplesFromSingleTier (Config &config, const ssi_char_t *prefix, ssi_size_t frameSize, ssi_size_t deltaSize, const ssi_char_t *tierName, bool includeInverted);
	static bool SamplesFromMultipleTiers (Config &config, const ssi_char_t *prefix, ssi_size_t frameSize, ssi_size_t deltaSize, ssi_size_t n_tier, const ssi_char_t *tierNames[]);	
