...
#ifndef SSI_MODEL_ISDUPLSTRMS_H
#define SSI_MODEL_ISDUPLSTRMS_H
...
class ISDuplStrms : public ISamples {

public:

	ISDuplStrms (ISamples *samples, ssi_size_t n_dupl);
	~ISDuplStrms ();	
	...
	ssi_size_t getStreamSize () { return _n_dupl; };
	ssi_stream_t getStream (ssi_size_t index) { return _samples.getStream (0); };
