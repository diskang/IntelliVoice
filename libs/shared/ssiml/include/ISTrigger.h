...
#ifndef SSI_MODEL_ISTRIGGER_H
#define SSI_MODEL_ISTRIGGER_H

#include "base/ISamples.h"

namespace ssi {

class ISTrigger : public ISamples {

public:

	ISTrigger (ISamples *samples);
	~ISTrigger ();	

	bool setTriggerStream (ssi_size_t index, ssi_stream_t &trigger, ssi_real_t thres);
